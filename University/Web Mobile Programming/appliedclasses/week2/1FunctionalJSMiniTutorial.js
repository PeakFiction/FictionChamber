...
console.log("MAP Function Output 2: ")
console.log(cents1)
console.log("==============================")
...
console.log("Filter Function Output 1: ")
console.log(passed1)
console.log("==============================")

let nums1 = [1,2,3,4,5,6];
let evens1 = nums1.filter(n => n % 2 === 0);
console.log("Filter Function Output 2: ")
console.log(evens1)
console.log("==============================")
...
*/ 
console.log("Reduce Function Output 1: ")
console.log(total1)
console.log("==============================")
...
console.log("Reduce Function Output 2: ")
