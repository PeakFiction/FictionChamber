...
class Counter:
    def __init__(self):
        ...
        IncrementButton = Button(mainWindow, text='Increment', bg='blue', fg='black', command=self.Increment)
        IncrementButton.pack()

        DecrementButton = Button(mainWindow, text='Decrement', bg='red', fg='black', command=self.Decrement)
        DecrementButton.pack()
        
        FunnyNumberButton = Button(mainWindow, text='Click for Funny Number', bg='purple', fg='black', command=self.funnyNumber)
